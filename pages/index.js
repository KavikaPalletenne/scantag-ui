...
export default function Home() {
  return (
      ...
      <div>
        ...
        <Head>
          <meta charset="utf-8" />
          <meta name="description" content="ScanTag allows you to easily locate your lost items. Whenever someone scans your QR code, we send you a notification. The finder can also see your contact details on your personal ScanTag page." />
                ...
                <div class="items-center md:flex">
                    <div class="w-full md:w-1/2">
                        <div class="max-w-2xl pr-4">
                            ...
                            <p class="mt-2 md:text-2xl text-gray-300 dark:text-gray-400 pb-10">The simple way for anyone to find lost items.</p>
                            <Link href="/register">
        ...
        <section>
            <div class="container max-w-7xl mx-auto pb-20 lg:pb-40 p-4 sm:p-6 pt-20 lg:pt-20 lg:p-8 bg-white dark:bg-gray-800">
                <div class="flex flex-wrap -mx-4">
                    <div class="w-full lg:w-1/2 px-8">
                        <div class="mb-12 lg:pt-10 lg:mb-0 pb-12 lg:pb-0 border-b lg:border-b-0">
                    ...
                    <div class="w-full lg:w-1/2 px-8">
                        <ul class="space-y-12">
                            <li class="flex -mx-4">
                                <div class="px-4">
                                    <span class="flex w-16 h-16 mx-auto items-center justify-center text-2xl font-bold font-heading rounded-full" style={{backgroundColor: "#ffebe3", color: "#FF9369"}}>
                                        1
                                    </span>
                                </div>
                                <div class="px-4">
        ...
        <footer class="dark:bg-gray-800 w-full py-8" style={{backgroundColor: "#FF9369"}}>
            <div class="max-w-screen-xl mx-auto px-4">
                <ul class="max-w-screen-md mx-auto text-lg font-light flex flex-wrap justify-between">
                    <li class="my-2">
                        <a class="text-white hover:text-gray-200 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="/faq">
                            FAQ
                        </a>
                    </li>
                    <li class="my-2">
                        <a class="text-white hover:text-gray-200 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="/site-map">
                            Site Map
                        </a>
                    </li>
                    <li class="my-2">
                        <a class="text-white hover:text-gray-200 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="/contact">
                            Contact
                        </a>
                    </li>
                    <li class="my-2">
                        <a class="text-white hover:text-gray-200 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="/legal">
                            Legal
                        </a>
                    </li>
                </ul>
