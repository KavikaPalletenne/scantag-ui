    ...
    return (
        ...
        <header className="h-screen min-h-full overflow-hidden">
            ...
            <div className="lg:pt-10 lg:pl-32 text-white lg:pr-32 pt-10 pl-5 pr-5">
                <Link href="/">
                <a>
                    <img className="float-left lg:w-20 w-12" src="https://raw.githubusercontent.com/KavikaPalletenne/scantag-assets/main/scantag-logo.svg"/>
                </a>
                </Link>
            </div>
            ...
            <div className="container lg:pl-32 lg:pt-48 pt-24 pl-5">
                <div className="items-center lg:flex">
                    <div className="w-full lg:w-2/3">
                        ...
                        <h1 className="text-7xl font-bold text-orange dark:text-white lg:text-9xl" style={{fontFamily: 'Rubik'}}>404</h1>
                            <h1 className="text-3xl font-bold text-white dark:text-white lg:text-7xl" style={{fontFamily: 'Rubik'}}>Page not found</h1>
