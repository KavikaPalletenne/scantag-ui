...
export default function Custom404() {
    return (
        ...
        <header className="h-screen h-full">
            ...
            <div className="container xl:pl-32 xl:pt-24 pt-24 pl-5">
                <div className="items-center xl:flex">
                    <div className="w-full xl:w-2/3">
                        <div className="max-w-2xl pr-4">
                        <h1 className="text-3xl font-bold text-orange dark:text-white xl:text-9xl" style={{fontFamily: 'Rubik'}}>404</h1>
